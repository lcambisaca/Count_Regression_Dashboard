...
Usage Examples
  1. Investigating and experimenting with Count Regression models.
  2. Examining data and attempting to fit various models.
  3. Gain basic insights into the relationship between a count response and various predictor variables.

End User License Agreement:
By downloading this program, you are agreeing to utilize this program with the understanding that it is fucntional for basic count regression and may be unable to accomodate excessively large or irregular data sets.
The information and interpretations should not be considered as the truth.  
The developers are not responsible for any consequences resulting from actions taken from assumptions made or interpretations drawn from this tool.
